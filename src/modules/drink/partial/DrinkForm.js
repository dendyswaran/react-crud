...
export default function DrinkForm({ initialValues }) {
    ...
    return (
        <div className="flex flex-col max-w-sm">
            ...
            <form onSubmit={handleBeforeSubmit}>
                ...
                <div className="flex">
                    <Button label="Save" />
                    <Button label="Cancel" type="button" className="p-button-secondary ml-2" onClick={() => navigate("/drink")} />
                </div>
            </form>
        </div>
    )
